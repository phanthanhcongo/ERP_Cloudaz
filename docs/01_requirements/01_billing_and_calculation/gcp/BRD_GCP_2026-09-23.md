...
1. Mở link billing riêng trên Google Cloud Console, chọn đúng Billing Account Reseller, lọc đúng tháng (kỳ billing).
2. Tải 2 bảng dữ liệu xuất từ Console: Bảng theo **Project ID / Project Number** (~621 dòng) và Bảng theo **Sub-Account / Billing ID** (~94 dòng).
