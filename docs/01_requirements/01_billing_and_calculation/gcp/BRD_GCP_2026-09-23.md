...
5. Chi phí **Gemini API** (Marketplace — không được chiết khấu 0% Discount): bị Google gộp chung vào tổng chi phí dịch vụ GCP Reseller (không nằm riêng ở cột nào). 
   ...
   - **Khách CÓ Gemini (~40-50% số lượng):** Kế toán phải mở Console/Project, lấy số tiền Gemini thực tế, bóc tách tay và chỉnh lại kết quả từ CM gen ra trước khi tính chiết khấu GCP.
