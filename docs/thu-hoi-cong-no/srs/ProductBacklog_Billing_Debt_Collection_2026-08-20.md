...
| BD - 19 | Epic 1: Billing & Dispute | Feature 07: Quy đổi tỷ giá & Bảng đối soát cước | Lưu trữ tập trung, tra cứu &| DC - 03 | Epic 2: Debt Collection | Feature 08: Hóa đơn VAT, ĐNTT & Chuyển phát | Quy trình trình ký, đóng dấu đỏ & thông báo HCNS chuyển phát bản cứng ĐNTT | Là một Kế toán / Hành chính nhân sự, tôi muốn Kế toán in bản cứng Đề nghị thanh toán trình ký và đóng dấu đỏ công ty, sau đó hệ thống tự động thông báo cho bộ phận Hành chính nhân sự qua nhận thư mang đi chuyển phát và cập nhật mã vận đơn, chỉ cho phép gửi email Đề nghị thanh toán sau khi Hành chính nhân sự xác nhận khách đã nhận bản cứng thành công. | AC1: Kế toán in bản cứng ĐNTT, trình ký đóng dấu đỏ công ty và bấm xác nhận trên hệ thống để gửi thông báo cho HCNS sang nhận thư.<br>AC2: HCNS nhận phong bì thư, gửi chuyển phát và cập nhật mã vận đơn / trạng thái xác nhận khách đã nhận bản cứng thành công.<br>AC3: **Ràng buộc bắt buộc:** Nút gửi email ĐNTT điện tử CHỈ ĐƯỢC MỜ KHÓA khi HCNS bấm xác nhận khách đã nhận bản cứng thành công (cảnh báo nếu quá 48h chưa có cập nhật). |l) cho mọi thao tác tính toán & chỉnh sửa cước.<br>AC2: Phân quyền chi tiết chức năng tính cước theo vai trò người dùng (Kế toán, Sales, Admin).<br>AC3: Tự động sinh báo cáo kiểm toán dữ liệu cước hàng tháng cho Kế toán trưởng. |
...
| ID | Epic Lớn | Feature Lớn | User Story (Short Desc) | User Story (Detail) | Acceptance Criteria |
|---|---|---|---|---|---|
| DC - 01 | Epic 2: Debt Collection | Feature 08: Hóa đơn VAT, ĐNTT & Chuyển phát | Quản lý xuất hóa đơn VAT & Tích hợp phần mềm hóa đơn MISA (chữ ký số) | Là một Kế toán doanh thu, tôi muốn kết xuất dữ liệu bảng cước đã chốt sang phần mềm MISA để ký số phát hành hóa đơn VAT và nhận tự động số hóa đơn điện tử về ERP, để quản lý hóa đơn tập trung mà không phải nhập tay. | AC1: Tự động kết xuất dữ liệu bảng cước đã chốt sang phần mềm hóa đơn MISA để kế toán ký chữ ký số và phát hành HĐ VAT.<br>AC2: Tích hợp kết nối hệ thống MISA để nhận trạng thái phát hành và số hóa đơn điện tử tự động về ERP.<br>AC3: Hỗ trợ phân loại xuất hóa đơn riêng cho từng pháp nhân công ty con hoặc điều chỉnh thông tin trước khi phát hành trên MISA.<br>AC4: Hỗ trợ quy trình phát hành hóa đơn điều chỉnh tăng/giảm trên phần mềm MISA khi có sai sót sau phát hành.<br>AC5: Đồng bộ và lưu trữ lịch sử toàn bộ hóa đơn VAT đã xuất từ phần mềm MISA về ERP theo khách/tháng/dịch vụ. |
| DC - 02 | Epic 2: Debt Collection | Feature 08: Hóa đơn VAT, ĐNTT & Chuyển phát | Lập & gộp Bộ chứng từ Đề nghị thanh toán (hỗ trợ nhiều hợp đồng & gộp đa dịch vụ) | Là một Kế toán doanh thu, tôi muốn lập Bộ chứng từ Đề nghị thanh toán từ các hóa đơn VAT đã phát hành (hoặc đính kèm file ĐNTT từ hệ thống CM), hỗ trợ gộp nhiều hợp đồng hoặc nhiều hóa đơn dịch vụ của cùng một khách hàng thành một đợt thu tiền duy nhất và xác định mốc hạn thanh toán (Ngày X), để bàn giao bộ chứng từ hoàn chỉnh cho bộ phận Hành chính nhân sự phát bản cứng. | AC1: Lập Bộ chứng từ thu nợ bằng cách kết nối Hóa đơn VAT MISA với file ĐNTT (lấy từ hệ thống CM đối với gói Committed hoặc tự động tạo đối với các dịch vụ khác).<br>AC2: Tự động xác định thời hạn thanh toán (mốc Ngày X) theo điều khoản hợp đồng.<br>AC3: Hỗ trợ gộp nhiều hợp đồng / hóa đơn VAT của cùng 1 khách hàng vào 1 ĐNTT duy nhất (Phase 1: Gộp các hợp đồng GWS Committed; Phase 2: Mở rộng gộp chéo với GCP, GMP, AWS).<br>AC4: Tự động tạo task bàn giao Bộ chứng từ thu nợ (dạng PDF) cho bộ phận Hành chính nhân sự để thực hiện in trình ký và chuyển phát bản cứng.<br>AC5: Quản lý danh sách email đại diện nhận thông báo công nợ theo hợp đồng. |
| DC - 03 | Epic 2: Debt Collection | Feature 08: Hóa đơn VAT, ĐNTT & Chuyển phát | Quy trình trình ký, đóng dấu đỏ & thông báo HCNS chuyển phát bản cứng ĐNTT | Là một Kế toán / Hành chính nhân sự, tôi muốn Kế toán in bản cứng Đề nghị thanh toán trình ký và đóng dấu đỏ công ty, sau đó hệ thống tự động thông báo cho bộ phận Hành chính nhân sự qua nhận thư mang đi chuyển phát và cập nhật mã vận đơn, chỉ cho phép gửi email Đề nghị thanh toán sau khi Hành chính nhân sự xác nhận khách đã nhận bản cứng thành công. | AC1: Kế toán in bản cứng ĐNTT, trình ký và đóng dấu đỏ công ty, sau đó bấm xác nhận "Đã đóng dấu đỏ bản cứng" trên hệ thống.<br>AC2: Tự động gửi thông báo cho bộ phận HCNS sang nhận phong bì bản cứng đã đóng dấu để gửi chuyển phát.<br>AC3: HCNS cập nhật thông tin chuyển phát (ngày gửi, đơn vị vận chuyển, mã vận đơn, xác nhận khách đã nhận thư thành công).<br>AC4: Tự động cảnh báo cho Kế toán và HCNS nếu quá 48h chưa có cập nhật trạng thái phát thư.<br>AC5: **Ràng buộc bắt buộc:** Nút gửi email ĐNTT điện tử CHỈ ĐƯỢC MỞ KHÓA khi HCNS bấm xác nhận khách đã nhận bản cứng thành công. |
